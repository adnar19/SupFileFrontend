...
const FileManager: React.FC = () => {
  ...
  const sidebarItems = [
    { icon: <File className="w-5 h-5" />, label: 'All Files', active: true },
    { icon: <Clock className="w-5 h-5" />, label: 'Recent', active: false },
    { icon: <Star className="w-5 h-5" />, label: 'Favorites', active: false },
    { icon: <Trash2 className="w-5 h-5" />, label: 'Trash', active: false }
  ];
          ...
          <header className="px-6 py-4" style={{ backgroundColor: 'var(--navbar-bg)', borderBottom: '1px solid var(--border-color)' }}>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                {/* Theme Toggle - même approche que la homepage */}
                <button 
